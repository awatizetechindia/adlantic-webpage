...
const HeroSection = ({
  ...
  return (
    <div className="flex flex-col justify-between md:flex-row gap-8 px-4 md:px-8 lg:px-8 py-16 md:py-24 mx-auto w-full">
      <div className="border-4 border-primary p-6 md:p-8 lg:p-12 flex-1">
        ...
        <p className="text-primary font-medium text-lg md:text-xl mb-8 leading-relaxed max-w-2xl">
          {description}
        </p>
